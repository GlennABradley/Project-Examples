...
peak.update({"range": "Elk Mountain"})
{'name': 'Castle Peak', 'height': 14264, 'summit_log': [], 'cell_reception': {'AT&T': 'no reception', 'T-Mobile': 'poor'}, 'range': 'Elk Mountain'}

# Add a "first_climbed" key to peak and set it equal to 1873

peak ["first_climbed"] = 1873
peak.update({"first_climbed": 1873})
{'name': 'Castle Peak', 'height': 14264, 'summit_log': [], 'cell_reception': {'AT&T': 'no reception', 'T-Mobile': 'poor'}, 'range': 'Elk Mountain', 'first_climbed': 1873}

# Whoops, there's a mistake with the peak "height".  Update it to 14265

peak ["height"] = 1873
{'name': 'Castle Peak', 'height': 1873, 'summit_log': [], 'cell_reception': {'AT&T': 'no reception', 'T-Mobile': 'poor'}, 'range': 'Elk Mountain', 'first_climbed': 1873}

# Add a "Verizon" to the "cell_reception" dict and set it equal to "good"

peak ["cell_reception"] ["Verzion"] = "Good"
{'name': 'Castle Peak', 'height': 1873, 'summit_log': ['Glenn Bradley'], 'cell_reception': {'AT&T': 'no reception', 'T-Mobile': 'poor', 'Verzion': 'Good'}, 'range': 'Elk Mountain', 'first_climbed': 1873}

# You just summited the peak! Add your name to the "summit_log" list

peak ["summit_log"].append("Glenn Bradley")
{'name': 'Castle Peak', 'height': 1873, 'summit_log': ['Glenn Bradley'], 'cell_reception': {'AT&T': 'no reception', 'T-Mobile': 'poor'}, 'range': 'Elk Mountain', 'first_climbed': 1873}
